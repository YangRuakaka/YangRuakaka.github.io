  ...
  requestAnimationFrame(()=>{
    entries.forEach(e=>{
      if (e.isIntersecting) {
        ...
        // Remove class when scrolling out of view for true scrollytelling
...
const scrollyData = {
  tongji: {
    section: '#about',
    frames: [
      { p: -0.1, x: 90, y: 110, rot: -45, scale: 0.5, op: 0 },
      { p: 0.3,  x: 80, y: 70,  rot: -10, scale: 0.8, op: 0.4 },
      { p: 0.7,  x: 75, y: 30,  rot: 15,  scale: 1.1, op: 0.4 },
      { p: 1.1,  x: 60, y: -20, rot: 45,  scale: 1.3, op: 0 }
    ]
  },
  nd: {
    section: '#about',
    frames: [
      { p: -0.1, x: -10, y: 100, rot: 60,  scale: 0.5, op: 0 },
      { p: 0.4,  x: 10,  y: 65,  rot: 10,  scale: 0.9, op: 0.4 },
      { p: 0.8,  x: 15,  y: 25,  rot: -10, scale: 1.1, op: 0.4 },
      { p: 1.2,  x: -5,  y: -20, rot: -40, scale: 1.3, op: 0 }
    ]
  },
  nd_irish: {
    section: '#about',
    frames: [
      { p: 0.0,  x: 50, y: 120, rot: -30, scale: 0.4, op: 0 },
      { p: 0.5,  x: 40, y: 80,  rot: 0,   scale: 0.7, op: 0.25 },
      { p: 1.0,  x: 30, y: -10, rot: 30,  scale: 1.0, op: 0 }
    ]
  },
  waterpolo_ball: {
...
console.log('Scrolly elements found:', scrollyElements.length);
